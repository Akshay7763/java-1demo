...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-3">
				<h3>All Offer's</h3>
				<p style="color: #b5b5c3">Great discounts with offers</p>
			</div>
			<div class="col-5">
				<input class="form-control" type="search" id="search-text"
					onkeyup="search(JSON.parse(sessionStorage.getItem('offerList')))"
		...
		<table>
			...
			<tbody id="insert-offer-here"></tbody>
		</table>
		<div id="notfound"></div>
	</div>
</body>
...
<script type="text/javascript"
	src="/DeccanSports/public/scripts/offer_list_page.js"></script>
<script type="text/javascript"
