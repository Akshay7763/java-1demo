	...
	<div class="container">
		...
		<div class="row top">
			...
			<div class="col top-1"
				...
				<label><strong>Sports</strong></label> <label class="arrow">🏋</label>
				<h2>${count.sports}</h2>
			...
			<div class="col top-2"
				...
				<label><strong>Batches</strong></label> <label class="arrow">📅</label>
				<h2>${count.batches}</h2>
				<label>View</label> <label class="arrow">&#8594;</label>
			</div>
			...
			<div class="col top-3"
				...
				<label><strong>Offers</strong></label> <label class="arrow">🎫</label>
				<h2>${count.offers-1}</h2>
				<label>View</label> <label class="arrow">&#8594;</label>
			</div>

			<!-- 4th block -->
			<div class="col top-4"
				onclick="window.location.href='/DeccanSports/listMembership'">
				<label><strong>Active Membership</strong></label> <label
					class="arrow">👦</label>
				<h2>${count.activeMemberships}</h2>
				<label>View</label> <label class="arrow">&#8594;</label>
			</div>
		</div>
	</div>
