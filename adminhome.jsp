...
<body onload="load()">
	...
	<div class="container">
		...
		<div class="row top">
			<!-- 1st block -->
			<div class="col top-1"
				onclick="window.location.href='/DeccanSports/fetchManager'">
				<label><strong>Appoint / Update</strong></label> <label
					class="arrow">👮</label>
				<h3>Manager</h3>
				<label>Go</label> <label class="arrow">&#8594;</label>
			</div>
		...
		<div class="row top">
			...
			<!-- 2nd block -->
			<div class="col top-5"
				onclick="window.location.href='/DeccanSports/logs'">
				<label><strong>Logs</strong></label> <label class="arrow">📖</label>
				<h2>${count.logs}</h2>
				<label>View</label> <label class="arrow">&#8594;</label>
			</div>
